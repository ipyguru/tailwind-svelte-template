<script>
  import DarkModeButton from "./Navbar/Includes/DarkModeButton.svelte";
...
<Footer footerType="sitemap">
  <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4 bg-gray-300 dark:bg-gray-700">
    <div>
      <h2 class="mb-6 text-sm font-semibold text-primary dark:text-light uppercase">Company</h2>
      <FooterLinkGroup ulClass="text-primary dark:text-light">
    ...
    <div>
      <h2 class="mb-6 text-sm font-semibold uppercase text-primary dark:text-light">Download</h2>
      <FooterLinkGroup ulClass="text-primary dark:text-light">
    ...
    <div>
      <h2 class="mb-6 text-sm font-semibold uppercasetext-primary dark:text-light">Legal</h2>
      <FooterLinkGroup ulClass="text-primary dark:text-light">
  ...
  <div class="py-6 px-4 bg-gray-400 dark:bg-gray-800 md:flex md:items-center md:justify-between">
    <FooterCopyright spanClass="text-sm text-slate-900 dark:text-light sm:text-center" href="/" by="Flowbite™" />
    <div class="flex mt-4 space-x-6 sm:justify-center md:mt-0 items-center">
      <DarkModeButton />

      <FooterIcon href="/" class="text-slate-900 dark:text-light hover:text-white">
